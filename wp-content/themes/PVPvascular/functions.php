...
add_image_size( 'featured-page-img', 223, 171 ); 
...
function toolbox_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Home Widget Area', 'toolbox' ),
		'id' => 'home-widgets',
		'description' => __( '', 'toolbox' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
		'before_title' => '<h1 class="widget-title">',
		'after_title' => '</h1>',
...
function register_my_menus() {
	register_nav_menus(
		array(
			...
			'siderbar-menu' => __( 'Sidebar Menus' ),
...
wp_register_script(
    'bootstrap-js',
    get_stylesheet_directory_uri().'/css/bootstrap/js/bootstrap.min.js',
    array('jquery')
);

wp_register_script(
    'vascular-js',
    get_stylesheet_directory_uri().'/js/pvpvascular.js',
    array('jquery')
);

function enqueue_site_scripts() {
    wp_enqueue_script('bootstrap-js');
    wp_enqueue_script('vascular-js');
}
